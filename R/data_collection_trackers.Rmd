...
df_data_support_cl_log <- df_tool_data |> 
    select(uuid, hh_zone, hh_woreda, hh_kebele, pop_group, latitude, longitude)
...
# sample data
df_samples_required <- readxl::read_excel("../support_files/lcsa_sample_size.xlsx") |> 
    select(hh_kebele, required_samples = tot_sample_size)
...
df_updated_tool_data |> 
  ...
  left_join(df_cl_surveys_for_deletion, by = c("hh_kebele" = "hh_kebele")) |> 
