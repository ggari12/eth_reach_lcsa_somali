...
# import clean data
clean_data_path <- "outputs/20240301_clean_data_eth_lcsa_somali.xlsx"
...
saveWorkbook(wb_log, paste0("outputs/", butteR::date_file_prefix(),"_eth_lcsa_data_cleaning_logbook.xlsx"), overwrite = TRUE)
openXL(file = paste0("outputs/", butteR::date_file_prefix(),"_eth_lcsa_data_cleaning_logbook.xlsx"))
